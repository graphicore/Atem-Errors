define(function() {
    ...
    errors.assert = function(exp, message) {
        if (!exp) {
            // Assertions should never raise, that's always a programming
            // error, thus the console.trace here can just stay. FF debugger
            // console doesn't show me a trace with some exceptions...
            console.trace();
